/* Servidor de archivos para probar cÃģdigo de los alumnos en lenguaje C++ 
      ...
      switch(pid){
         ...
         case 0: //Hijo      
            ...
            while(1){                   
               ...
               cout << "\nLa IP de quien me enviÃģ es: " << recepcion.obtieneDireccion() << endl;
               cout << "El puerto de quien me enviÃģ es: " << recepcion.obtienePuerto() << endl;      
               //recepcion.~PaqueteDatagrama();
               memcpy((char *)&mensRcb, recepcion.obtieneDatos(), sizeof(mensRcb));
               cout << "OpciÃģn recibida: = " << mensRcb.opcode << endl;               
